...
<head>
  ...
  <link href="{{asset('temp/css/reset.min.css?v=2.1.1')}}" rel="stylesheet">
  <!-- Bootstrap -->
  <link href="{{asset("temp/plugins/bootstrap/css/bootstrap.min.css")}}" rel="stylesheet">
    <link href='{{asset("temp/plugins/roboto/roboto.css")}}' rel='stylesheet'>
  <link href='{{asset("temp/css/bs-overides.min.css")}}' rel='stylesheet'>
