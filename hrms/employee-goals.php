                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul class="nav nav-tabs tabs-design">
                                <li class="nav-item">
                                    <a class="nav-link" href="goals.php">Personal Goals</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link active" href="employee-goals.php">Employee Goals</a>
                                </li>
                                <li class="nav-item">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-5">
                                    <h3 class="mb-1">Employee Goals</h3>
                                    <h5 class="text-left text-gray mb-3">Goals for company employee</h5>
                                ...
                                <div class="col-md-4">
                                    <div class="jumbotron p-4 bg-light-gray">
                                        ...
                                        <p class="mdi mdi-eye mb-0 font-weight-bold"> Visible to everyone in the company</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-dialog modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h4 class="modal-title">Add Employee Goal</h4>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <div class="form-radio d-inline-block mb-1">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="optionsRadios" id="optionsRadios1" value="" checked>Visible to everyone in the company
                                                    <i class="input-helper"></i></label>
                                            </div>
                                            <div class="form-radio d-inline-block mt-2">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="optionsRadios" id="optionsRadios1" value="">Visible only to team employees & managers
                                                    <i class="input-helper"></i></label>
                                            </div>
                                        </div>
                                    </div>
